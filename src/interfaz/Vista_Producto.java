...
public class Vista_Producto extends JDialog {
    ...
    //CONSTRUCTOR
    public Vista_Producto(JFrame parent, boolean modal, Producto producto, int cod, String nom, float pre, float iv, int min, int max, int can, String est) {
        super(parent, modal);
        this.producto = producto;
        setUndecorated(true);
        setBackground(new Color(0, 0, 0, 0));//FONDO TRANSPARENTE PARA QUE NO SE VEAN LOS BORDES DE LA VENTANA
        initComponents();
        inicializar(parent);
        llenar(cod, nom, pre, iv, min, max, can, est);
    }

    //CARGAR INFO DEL PRODUCTO EN LOS LABEL
    public void llenar(int cod, String nom, float pre, float iv, int min, int max, int cant, String est) {
        cl.setText("Codigo " + cod);
        nl.setText("Nombre: " + nom);
        pl.setText("Precio: " + pre);
        il.setText("Iva: " + iv);
        lmin.setText("Stock Min: " + min);
        lmax.setText("Stock Max: " + max);
        cal.setText("Cantidad: " + cant);
        el.setText("Estado: " + est);
    }

    //QUITAR LOS BORDES A LA VENTANA PARA QUE SE VEA COMO UN PANEL FLOTANTE
    ...
    private void initComponents() {
        ...
        modificar2.setText("Detalles del Producto");
        ...
        cal.setText("Cantidad:");

        il.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        il.setText("Iva:");

        el.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        el.setText("Estado:");

        lmin.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lmin.setText("Stock Min:");

        lmax.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lmax.setText("Stock Max:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        producto.borrar_busqueda();//LIMPIAR INPUT
